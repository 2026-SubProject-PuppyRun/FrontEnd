...
const sliderThumbStyle = tva({
  base: "absolute rounded-full bg-primary-500 shadow-hard-1 data-[active=true]:bg-primary-600 data-[disabled=true]:bg-primary-500 data-[focus=true]:bg-primary-600 data-[hover=true]:bg-primary-600 web:cursor-pointer web:data-[active=true]:outline web:data-[active=true]:outline-4 web:data-[active=true]:outline-primary-400",
...
const sliderFilledTrackStyle = tva({
  base: "bg-primary-500 data-[active=true]:bg-primary-600 data-[focus=true]:bg-primary-600 data-[hover=true]:bg-primary-600",
  parentVariants: {
    orientation: {
      horizontal: "h-full",
      vertical: "w-full",

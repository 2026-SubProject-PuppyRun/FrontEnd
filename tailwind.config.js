...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        heading: ["SpoqaHanSansNeo-Bold"],
        body: ["SpoqaHanSansNeo-Regular"],
        mono: undefined,
        sans: ["SpoqaHanSansNeo-Regular"],
        spoqa: ["SpoqaHanSansNeo-Regular"],
        "spoqa-thin": ["SpoqaHanSansNeo-Thin"],
        "spoqa-light": ["SpoqaHanSansNeo-Light"],
        "spoqa-medium": ["SpoqaHanSansNeo-Medium"],
        "spoqa-bold": ["SpoqaHanSansNeo-Bold"],
